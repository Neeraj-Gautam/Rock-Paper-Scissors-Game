...
// Function to get scores from local storage/Array
...
const getRandomNumber = () => {
  // Generate a random decimal number from 0 to 1
  const randomDecimal = Math.random();

  // random number from 1,2 and 3
...
const updateScores = (result) => {
  ...
  // Update the scores according to result
  if (result === "user") {
    scores.user += 1;
  } else if (result === "comp") {
    scores.computer += 1;
